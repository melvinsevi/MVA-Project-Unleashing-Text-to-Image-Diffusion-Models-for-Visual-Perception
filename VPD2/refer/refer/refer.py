...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        tic = time.time()
        ref_file = osp.join('VPD2'+self.DATA_DIR[1:], 'refs(' + splitBy + ').p')
        self.data = {}
        ...
        instances_file = osp.join('VPD2'+ self.DATA_DIR[1:], 'instances.json')
...
if __name__ == '__main__':
    refer = REFER("/content/drive/MyDrive/VPD2/refer/data",dataset='refcocog', splitBy='google')
