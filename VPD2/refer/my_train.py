...
def main(args):
    ...
    model = VPDRefer(sd_path='VPD2/checkpoints/v1-5-pruned-emaonly.ckpt',
    ...
    for name, m in model.named_parameters():
      if 'unet' not in name and 'encoder_vq' not in name:
    ...
    def count_parameters_to_optimize(params_to_optimize):
        total_params = 0
    ...
    # Example usage:
    num_params_to_optimize = count_parameters_to_optimize(params_to_optimize)
    print(f"Number of parameters to optimize: {num_params_to_optimize}")
